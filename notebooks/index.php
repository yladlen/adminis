...
<div class="content-wrapper">
    <div class="content-container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="../rooms/add_device.php?from=notebooks" class="btn btn-outline-success">➕ Добавить ноутбук</a>
        </div>
            ...
            <div class="table-responsive">
                <table id="main-table">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr onclick="location.href='../rooms/edit_device.php?id=<?= $item['id'] ?>&from=notebooks'" style="cursor:pointer">
