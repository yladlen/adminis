...
<div class="content-wrapper">
    <div class="content-container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="../rooms/add_device.php?from=printers" class="btn btn-outline-success">➕ Добавить</a>
        </div>
        ...
        <?php if (empty($items)): ?>
            <p class="p-center">Принтеры не найдены.</p>
        <?php else: ?>
            <div class="table-responsive">
                <table id="main-table">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr onclick="location.href='../rooms/edit_device.php?id=<?= $item['id'] ?>&from=printers'" style="cursor:pointer">
